...
export const WIDGET_SIZE_CONSTRAINTS: Record<string, WidgetSizeConfig> = {
  ...
  AggregateGoalWidget: { minW: 3, minH: 2, maxW: 24, maxH: 24, defaultW: 8, defaultH: 3 },
  ...
  CameraViewerWidget: { minW: 4, minH: 3, maxW: 24, maxH: 24, defaultW: 6, defaultH: 4 },
  DataTableWidget: { minW: 4, minH: 3, maxW: 24, maxH: 24, defaultW: 8, defaultH: 4 },
};
